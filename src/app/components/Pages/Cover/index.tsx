    ...
    <div className={styles.background}>
        <div className="flex flex-col w-full h-full md:h-3/4 md:w-3/4 md:pt-10 m-auto text-center justify-around md:justify-evenly space-y-52 md:space-y-5">
            <div className="md:space-y-4">
                <div className="flex flex-col justify-evenly w-11/12 md:w-full mx-auto">
            ...
            <button className="rounded-3xl w-1/2 md:w-1/4 mx-auto p-2 md:p-3 text-secondary bg-white font-bold text-lg md:text-xl">
                <Link
                    activeClass="active"
                    to="bride-groom"
                    spy={true}
